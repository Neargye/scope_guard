...
set(config_args "-DCMAKE_CXX_COMPILER=${SCOPE_GUARD_CXX_COMPILER}")
...
elseif(SCOPE_GUARD_INTEGRATION_MODE STREQUAL "subproject-defaults")
    set(consumer_args "-DSCOPE_GUARD_SOURCE_DIR=${SCOPE_GUARD_SOURCE_DIR}" -DSCOPE_GUARD_TEST_SUBPROJECT_DEFAULTS=ON)
else()
